...
require_relative "../../lib/giraffe/tree/sizeofTree.rb"
...
module Giraffe
    ...
    class TestSizeofTree < Test::Unit::TestCase
        ...
        def test_run            
            ...
            assert_equal(env.codegen.bytecode[4].value, Opcodes::SZOF)

            dummy = DummyTree.new(true)
            tree = SizeofTree.new([dummy,"ast"])
            return_value, msg = tree.run(env, dummy_AST)
