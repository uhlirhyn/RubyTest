...
# Generated at: 2011-11-11 00:53:02
# 
...
module Giraffe
  ...
  module TokenData
    ...
    define_tokens( :LT => 23, :EXPONENT => 40, :WHILE => 12, :RB => 18, 
                   :MOD => 32, :OCTAL_ESC => 45, :CHAR => 36, :DO => 13, 
                   :FOR => 14, :FLOAT => 34, :NOT => 27, :AND => 20, :RCB => 5, 
  ...
  class Lexer < ANTLR3::Lexer
    ...
    def id!
      ...
      # - - - - main rule block - - - -
      # at line 172:7: ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '0' .. '9' | '_' )*
    ...
    def float!
      ...
      # - - - - main rule block - - - -
      # at line 179:5: ( ( '0' .. '9' )+ '.' ( '0' .. '9' )* ( EXPONENT )? | '.' ( '0' .. '9' )+ ( EXPONENT )? | ( '0' .. '9' )+ EXPONENT )
      alt_9 = 3
      alt_9 = @dfa9.predict( @input )
      case alt_9
      when 1
        # at line 179:9: ( '0' .. '9' )+ '.' ( '0' .. '9' )* ( EXPONENT )?
        # at file 179:9: ( '0' .. '9' )+
        match_count_3 = 0
        while true
          alt_3 = 2
    ...
    def string!
      ...
      # - - - - main rule block - - - -
      # at line 196:8: '\"' ( ESC_SEQ | ~ ( '\\\\' | '\"' ) )* '\"'
      match( 0x22 )
      # at line 196:12: ( ESC_SEQ | ~ ( '\\\\' | '\"' ) )*
    ...
    def char!
      ...
      # - - - - main rule block - - - -
      # at line 199:8: '\\'' ( ESC_SEQ | ~ ( '\\'' | '\\\\' ) ) '\\''
      match( 0x27 )
      # at line 199:13: ( ESC_SEQ | ~ ( '\\'' | '\\\\' ) )
      alt_12 = 2
    ...
    def esc_seq!
      ...
      # - - - - main rule block - - - -
      # at line 210:5: ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | '\\\"' | '\\'' | '\\\\' ) | UNICODE_ESC | OCTAL_ESC )
      alt_15 = 3
      ...
      when 2
        # at line 211:9: UNICODE_ESC
        unicode_esc!

      when 3
        # at line 212:9: OCTAL_ESC
        octal_esc!
    ...
    def octal_esc!
      ...
      # - - - - main rule block - - - -
      # at line 217:5: ( '\\\\' ( '0' .. '3' ) ( '0' .. '7' ) ( '0' .. '7' ) | '\\\\' ( '0' .. '7' ) ( '0' .. '7' ) | '\\\\' ( '0' .. '7' ) )
      alt_16 = 3
    ...
    def unicode_esc!
      ...
      # - - - - main rule block - - - -
      # at line 224:9: '\\\\' 'u' HEX_DIGIT HEX_DIGIT HEX_DIGIT HEX_DIGIT
      match( 0x5c )
      match( 0x75 )
      hex_digit!
      hex_digit!
